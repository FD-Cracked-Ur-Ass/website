...
local themes = {
    ...
    Midnight = {
        ...
        MainFrame = Color3.fromRGB(30, 30, 36),
        TabBackground = Color3.fromRGB(20, 20, 24),
        Tab = Color3.fromRGB(8, 22, 60),
        EnabledText = Color3.fromRGB(180, 180, 190),
        DisabledText = Color3.fromRGB(180, 180, 190),
        TabToggleEnabled = Color3.fromRGB(8, 22, 60),
        TabToggleDisabled = Color3.fromRGB(5, 5, 5),
        TabToggleDisabledMouseOver = Color3.fromRGB(30, 30, 36),
        Section = Color3.fromRGB(30, 30, 36),
        Button = Color3.fromRGB(8, 22, 60),
        ButtonMouseOver = Color3.fromRGB(30, 30, 36),
        ToggleEnabled = Color3.fromRGB(45, 45, 55),
        ToggleEnabledMouseOver = Color3.fromRGB(30, 30, 36),
        ToggleDisabled = Color3.fromRGB(8, 22, 60),
        ToggleDisabledMouseOver = Color3.fromRGB(30, 30, 36),
        Box = Color3.fromRGB(8, 22, 60),
        BoxFocused = Color3.fromRGB(30, 30, 36),
        Slider = Color3.fromRGB(8, 22, 60),
        SliderMouseOver = Color3.fromRGB(30, 30, 36),
        SliderFill = Color3.fromRGB(100, 59, 154),
        SliderFillSliding = Color3.fromRGB(45, 45, 55),
        Dropdown = Color3.fromRGB(8, 22, 60),
        DropdownMouseOver = Color3.fromRGB(30, 30, 36),
        DropdownContent = Color3.fromRGB(45, 45, 55),
        ColorPicker = Color3.fromRGB(45, 45, 55),
        ColorPickerBoxes = Color3.fromRGB(8, 22, 60)
    }
}
